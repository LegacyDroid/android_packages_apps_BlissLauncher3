 ...
 */
/*
 * File:    bliss/src/foundation/e/bliss/policy/idle/HonorGapsIdleAppPolicy.kt
...
object HonorGapsIdleAppPolicy : IdleAppPolicy {
    override fun shouldAutoFillIdle(): Boolean = false
}
