 ...
 */
// PLAN-DRIFT-M02: see 13-drift-log.md Phase 2.2 — placed in package com.android.launcher3.folder
// (under bliss/src) instead of foundation.e.bliss.folder.anim, so the spring animator can use the
// existing package-private field access on
// Folder/FolderIcon/PreviewBackground/PreviewItemDrawingParams
// the same way Lawnchair upstream does. Avoids ~10 visibility bumps in upstream-aligned files.
