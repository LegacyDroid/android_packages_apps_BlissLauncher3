 ...
 */
/*
 * File:    src/com/android/launcher3/settings/ui/FoldersFragment.java
 ...
 *
 * Purpose:
 *   Folder appearance settings. Inflates preferences_folders.xml and lets {@link
...
public class FoldersFragment extends AreaFragmentBase {
    @Override protected int xmlRes() { return R.xml.preferences_folders; }
}
