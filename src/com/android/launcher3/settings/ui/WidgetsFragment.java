 ...
 */
/*
 * File:    src/com/android/launcher3/settings/ui/WidgetsFragment.java
 ...
 *
 * Purpose:
 *   Widget rendering settings. Inflates preferences_widgets.xml and lets {@link
...
public class WidgetsFragment extends AreaFragmentBase {
    @Override protected int xmlRes() { return R.xml.preferences_widgets; }
}
