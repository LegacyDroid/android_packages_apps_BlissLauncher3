 ...
 */
/*
 * File:    src/com/android/launcher3/settings/controllers/drawer/DrawerAnimationController.java
 ...
 *
 * Purpose:
 *   List — drawer open animation style.
 *
...
/** List — drawer open animation style. */
public final class DrawerAnimationController implements PreferenceController {
    @NonNull @Override public String key() { return BlissPrefs.PREF_DRAWER_ANIMATION; }
    ...
    @Override public void onAttach(@NonNull Preference preference, @NonNull Context ctx) {
        ...
        String[] labels = new String[] {
            ctx.getString(R.string.drawer_anim_default),
            ctx.getString(R.string.drawer_anim_fade),
            ctx.getString(R.string.drawer_anim_none)
        };
