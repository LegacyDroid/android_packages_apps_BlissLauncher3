 ...
 */
/*
 * File:    src/com/android/launcher3/settings/controllers/folders/FolderBgColorController.java
 ...
 *
 * Purpose:
 *   List — folder background colour preset.
 *
...
/** List — folder background colour preset. */
public final class FolderBgColorController implements PreferenceController {
    @NonNull @Override public String key() { return BlissPrefs.PREF_FOLDER_BG_COLOR; }
    ...
    @Override public void onAttach(@NonNull Preference preference, @NonNull Context ctx) {
        ...
        String[] labels = new String[] {
            ctx.getString(R.string.folder_bg_default),
            ctx.getString(R.string.folder_bg_black),
            ctx.getString(R.string.folder_bg_white),
            ctx.getString(R.string.folder_bg_dark_gray)
        };
