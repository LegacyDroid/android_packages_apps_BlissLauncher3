 ...
 */
/*
 * File:    src/com/android/launcher3/settings/controllers/dock/DockBgColorController.java
 ...
 *
 * Purpose:
 *   List — dock background colour preset.
 *
...
/** List — dock background colour preset. */
public final class DockBgColorController implements PreferenceController {
    @NonNull @Override public String key() { return BlissPrefs.PREF_DOCK_BG_COLOR; }
    ...
    @Override public void onAttach(@NonNull Preference preference, @NonNull Context ctx) {
        ...
        String[] labels = new String[] {
            ctx.getString(R.string.dock_bg_default),
            ctx.getString(R.string.dock_bg_black),
            ctx.getString(R.string.dock_bg_white),
            ctx.getString(R.string.dock_bg_dark_gray),
            ctx.getString(R.string.dock_bg_transparent)
        };
