...
object ShapesProvider {
    ...
    private const val SHARP_SQUARE_PATH =
    ...
    const val SHARP_SQUARE_KEY = "sharp_square"
    ...
    val iconShapes: Array<IconShapeModel> =
        if (Flags.newCustomizationPickerUi() && LauncherFlags.enableLauncherIconShapes()) {
            arrayOf(
                IconShapeModel(
                    key = SHARP_SQUARE_KEY,
                    titleId = R.string.sharp_square_shape_title,
                    pathString = SHARP_SQUARE_PATH,
