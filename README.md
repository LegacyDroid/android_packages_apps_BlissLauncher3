...
- We need to build the `Trebuchet` module using `m Trebuchet` and then copy the jars from the following directories:

  - **framework-15.jar**: `out/soong/.intermediates/frameworks/base/framework/android_common/turbine-combined/framework.jar`

  - **classes.jar**: `out/target/common/obj/JAVA_LIBRARIES/Launcher3QuickStepLib_intermediates/classes.jar`

  - **aconfig-annotations-lib.jar**: `out/soong/.intermediates/frameworks/libs/modules-utils/java/aconfig-annotations-lib/linux_glibc_common/javac/aconfig-annotations-lib.jar`
  ...
  - **framework-annotations-lib.jar**: `/out/soong/.intermediates/frameworks/libs/modules-utils/java/framework-annotations-lib/android_common/javac/framework-annotations-lib.jar`

  - **unsupportedappusage.jar**: `out/soong/.intermediates/tools/platform-compat/java/android/compat/annotation/unsupportedappusage/android_common/javac/unsupportedappusage.jar`
