...
- We need to build the `BlissLauncher3 and Launcher3QuickStepLib` module using `m BlissLauncher3 Launcher3QuickStepLib` and then copy the jars from the following directories:
