...
def process_file(src_path, dest_path):
    ...
    if '?androidprv:attr/textColorOnAccent' in content:
        content = content.replace('?androidprv:attr/textColorOnAccent', '@color/e_background')
        modified = True

    if '?androidprv:attr/colorAccentPrimaryVariant' in content:
        content = content.replace('?androidprv:attr/colorAccentPrimaryVariant', '@color/e_background_variant')
        modified = True

    if '?androidprv:attr/colorAccentPrimary' in content:
        content = content.replace('?androidprv:attr/colorAccentPrimary', '@color/e_background_inverse')
        modified = True
