 ...
 */
/*
 * File:    bliss-folders-data/src/main/kotlin/foundation/e/bliss/folders/db/DrawerFolderDao.kt
 * Module:  :bliss-folders-data
 * Role:    Room DAO for persisted drawer-folder rows and item rows.
 *
 * Owned by:
 *   - :bliss-folders-data
 *
 ...
 *
 * Dependency rules:
 *   - May use AndroidX Room and Kotlin Flow.
